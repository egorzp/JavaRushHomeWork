...
public class Solution
{
    public static void main(String[] args) throws IOException
    {
        ...
        Cat catGrFather = new Cat(reader.readLine());
        Cat catGrMother = new Cat(reader.readLine());
        Cat catFather = new Cat(reader.readLine(), catGrFather, null);
        Cat catMother = new Cat(reader.readLine(), null, catGrMother);
